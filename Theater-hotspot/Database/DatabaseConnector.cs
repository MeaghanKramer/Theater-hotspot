...
namespace Theater_hotspot.Database
{
    public static class DatabaseConnector
    {
        ...
        public static List<Dictionary<string, object>> GetRows(string query)
        {
            ...
            string connectionString = "Server=informatica.st-maartenscollege.nl;Port=3306;Database=110712;Uid=110712;Pwd=inf2122sql;";
